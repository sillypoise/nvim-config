...
return {
    ...
    { "nvim-telescope/telescope-file-browser.nvim" },
    {
        ...
        config = function()
            ...
            -- Telescope Mappings
            vim.keymap.set('n', '<leader>ro', require('telescope.builtin').oldfiles,
                { desc = '[R]ecently [O]pened files' })
            vim.keymap.set('n', '<leader>;', require('telescope.builtin').buffers, { desc = '[ ] Find existing uffers' })
